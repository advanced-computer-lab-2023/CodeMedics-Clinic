...
class PatientAppointmentInfoWidget extends StatelessWidget {
  PatientAppointmentInfoWidget({super.key, required this.appointment}) {
    Get.put(PatientAppointmentsController());
  }
  final Appointment appointment;
  @override
  Widget build(BuildContext context) {
    return GetBuilder<PatientAppointmentsController>(builder: (ctrl) {
      return Stack(
        children: [
          Padding(
